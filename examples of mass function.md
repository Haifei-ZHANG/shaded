...
# m2 = MassFunction({'a':0.6, 'b':0.1, 'c':0, 'abc':0.3})
# m3 = MassFunction({'a':0.5, 'b':0.1, 'c':0.2, 'abc':0.2})
# m4 = MassFunction({'a':0.9, 'b':0.1, 'c':0})
# m5 = MassFunction({'a':x, 'b':0.1, 'c':0.9-x})
...
# m6 = MassFunction({'abc':1})

# x = 0.2
# m1 = MassFunction({'a':0.06, 'b':0.68, 'c':0.02, 'd':0.04, 'abcd':0.2})
# m2 = MassFunction({'a':0.02, 'b':x, 'c':0.79-x, 'd':0.05, 'abcd':0.14})
# m3 = MassFunction({'a':0.02, 'b':0.58, 'c':0.16, 'd':0.04, 'abcd':0.2})
# m4 = MassFunction({'abc':1})
# m5 = MassFunction({'abc':1})
# m6 = MassFunction({'abc':1})
